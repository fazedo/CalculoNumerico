...
\begin{exer} Encontre uma aproximação para os coeficientes $a$ e $b$ tais que a reta definida por $y = ax + b$ passa pelo ponto $(3, 1/2)$ é tangente à curva definida por $y=e^{-(x-1)^2}$ em algum outro ponto. Encontre também o ponto de tangência. Expresse a solução com cinco algarismo significativos corretos.
\end{exer}
\begin{resp} $a \approx  = -0,25842$ e  $b \approx 1,2753$. O ponto de tangência é aproximadamente $(1,1315, 0,98287)$.
\end{resp}
